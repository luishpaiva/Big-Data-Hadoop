...
public class Informacao5 {
    ...
    public static class MapperInformacao5 extends Mapper<Object, Text, Text, LongWritable> {
    ...
    public static class ReducerInformacao5 extends Reducer<Text, LongWritable, Text, LongWritable> {
    ...
    public static void main(String[] args) throws IOException, InterruptedException, ClassNotFoundException {
        ...
        String caminhoSaida = "/home2/ead2022/SEM1/paiva.l/Desktop/luis.paiva/informacao5";
        ...
        Job job = Job.getInstance(conf, "informacao5Resposta");
