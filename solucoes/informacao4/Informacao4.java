...
public class Informacao4 {
    ...
    public static class MapperInformacao4 extends Mapper<Object, Text, Text, LongWritable> {
    ...
    public static class ReducerInformacao4 extends Reducer<Text, LongWritable, Text, LongWritable> {
    ...
    public static void main(String[] args) throws IOException, InterruptedException, ClassNotFoundException {
        ...
        String caminhoSaida = "/home2/ead2022/SEM1/paiva.l/Desktop/luis.paiva/informacao4";
        ...
        Job job = Job.getInstance(conf, "informacao4Resposta");
